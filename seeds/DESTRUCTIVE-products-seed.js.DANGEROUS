...
const sampleProducts = [
  ...
  },
  {
    ...
    options: {
      quantities: [
        { name: "500", priceModifier: 0 },
        { name: "1000", priceModifier: 15 },
        { name: "2500", priceModifier: 50 },
        { name: "5000", priceModifier: 110 },
        { name: "7500", priceModifier: 165 },
        { name: "10000", priceModifier: 220 },
        { name: "15000", priceModifier: 330 },
        { name: "25000", priceModifier: 550 },
      ],
      sizes: [
        {
          name: '4" x 6"',
      ...
      paperTypes: [
        { name: "14pt Gloss Cover", priceModifier: 0 },
        { name: "14pt Uncoated Cover", priceModifier: 0 },
        { name: "14pt Matte Cover", priceModifier: 0 },
        { name: "16pt Gloss Cover", priceModifier: 10 },
        { name: "16pt Uncoated Cover", priceModifier: 10 },
        { name: "13pt Premium Linen", priceModifier: 20 },
        { name: "18pt Ultra Premium Smooth White", priceModifier: 35 },
      ],
      colors: [
        { name: "Full Color Front, No Back", priceModifier: 0 },
        { name: "Full Color Front, Grayscale Back", priceModifier: 0 },
        { name: "Full Color Both Sides", priceModifier: 15 },
      ],
      roundedCorners: [
        { name: "No", priceModifier: 0 },
        { name: "Yes", priceModifier: 20 },
      ],
      coatings: [
        { name: "Matte Aqueous Coating - Front", priceModifier: 0 },
        { name: "Matte Aqueous Coating - Both Sides", priceModifier: 0 },
        { name: "UV Gloss Coating - Front", priceModifier: 0 },
        { name: "UV Gloss Coating - Both Sides", priceModifier: 0 },
        { name: "Spot UV Coating - Front", priceModifier: 25 },
      ],
      raisedPrint: [
        { name: "None", priceModifier: 0 },
        { name: "Raised UV Print Front", priceModifier: 40 },
        { name: "Raised UV Both Sides", priceModifier: 55 },
        { name: "Raised Foil Print Front", priceModifier: 40 },
        { name: "Raised Foil Print Both Sides", priceModifier: 55 },
      ],
    },
    inStock: true,
    featured: false,
